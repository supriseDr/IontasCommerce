<div class="bg-white">
      ...
      <div class="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
        ...
        <div class="group relative">
          ...
          <div class="mt-4 flex justify-between">
            ...
            <p class="text-sm font-medium text-gray-900"><?php echo e($product->getPrice()); ?></p>
            <form>
  ...
  <?php /**PATH /home/jing/Documents/IontasCommerce/views///components/products-list.blade.php ENDPATH**/ ?>