      ...
      <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
          <a href="#">
              ...
              <div class="pt-3 flex items-center justify-between">
                  <p class=""><?php echo e($product->getName()); ?></p>
              ...
              <p class="pt-1 text-gray-900">R <?php echo e($product->getPrice()); ?></p>
          </a>
          <form action="/cart/add/<?php echo e($product->getId()); ?>" method="POST">
...
</section><?php /**PATH /home/jing/Documents/IontasCommerce/views///components/products-list.blade.php ENDPATH**/ ?>