...
<div class="relative bg-white">
  ...
  <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
   ...
   <form action="/sign-out" method="POST"> 
    <button type="submit" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
      Sign Out
    </button>
   </form>
...
<?php /**PATH /home/jing/Documents/IontasCommerce/views///components/navbar.blade.php ENDPATH**/ ?>